...
<div class="page-body">
    <div class="container-xl">
        <div class="row row-cards">
            <div class="col-12">
                @if(isset($reservasi))
                {!! Form::model($reservasi, ['route' => ['paket.update', $reservasi->id], 'method' => 'patch',
                ...
                <div class="card-header">
                    <h4 class="card-title">Sunting Reservasi</h4>
                </div>
                @else
                <div class="card-header">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-xl-12">
                                    <div class="mb-3">
                                        ...
                                        {!! Form::text('paket', Input::old('paket'), ['id' => 'paket',
                                        'class'
                                        =>
                                    ...
                                    <div class="mb-3">
                                        {!! Form::label('catatan', 'Catatan', ['class' => 'form-label']) !!}
                                        {!! Form::text('catatan', Input::old('catatan'), ['id' => 'catatan',
                                        'class' =>
                                        'form-control']) !!}
                                    </div>
                                    <div class="mb-3">
