...
<!-- Main Content -->
<section class="hero-wrap js-fullheight" style="background-image: url('{{asset('haircare/images/camera0.jpg')}}');" data-stellar-background-ratio="0.5">
	...
	<div class="container-fluid px-0">
		<div class="row no-gutters">
			<div class="col-md text-center d-flex align-items-stretch">
				<div class="services-wrap d-flex align-items-center img" style="background-image: url('{{asset('haircare/images/indoor.jpg')}}');">
					<div class="text">
						<h3>Foto Indoor</h3>
						<p><a href="{{ route('user.paket-foto') }}" class="btn-custom">Lihat Harga <span class="ion-ios-arrow-round-forward"></span></a></p>
					</div>
				</div>
			</div>
			<div class="col-md-3 text-center d-flex align-items-stretch">
				<div class="text-about py-5 px-4">
					...
					<p class="mt-3"><a href="{{ route('user.tentang') }}" class="btn btn-primary btn-outline-primary">Read more</a></p>
				</div>
			</div>
			<div class="col-md text-center d-flex align-items-stretch">
				<div class="services-wrap d-flex align-items-center img" style="background-image: url('{{asset('haircare/images/outdoor.jpg')}}');">
					<div class="text">
						<h3>Foto Outdoor</h3>
						<p><a href="{{ route('user.paket-foto') }}" class="btn-custom">Lihat Harga <span class="ion-ios-arrow-round-forward"></span></a></p>
					</div>
			...
			<div class="col-md-3 ftco-animate">
				<div class="pricing-entry pb-5 text-center">
					<div>
						...
						<p><span class="price">IDR {{ number_format($paket->harga, 0, ',', '.') }}</span> <span class="per">/ sesi</span></p>
					</div>
					<ul>
				...
				<div class="carousel-team owl-carousel">
					<div class="item">
						<a href="#" class="team text-center">
							<div class="img" style="background-image: url('{{asset('haircare/images/stylist-1.jpg')}}');"></div>
							<h2>Danica Lewis</h2>
					...
					<div class="item">
						<a href="#" class="team text-center">
							<div class="img" style="background-image: url('{{asset('haircare/images/stylist-2.jpg')}}');"></div>
							<h2>Nicole Simon</h2>
					...
					<div class="item">
						<a href="#" class="team text-center">
							<div class="img" style="background-image: url('{{asset('haircare/images/stylist-3.jpg')}}');"></div>
							<h2>Cloe Meyer</h2>
					...
					<div class="item">
						<a href="#" class="team text-center">
							<div class="img" style="background-image: url('{{asset('haircare/images/stylist-4.jpg')}}');"></div>
					...
					<div class="item">
						<a href="#" class="team text-center">
							<div class="img" style="background-image: url('{{asset('haircare/images/stylist-5.jpg')}}');"></div>
							<h2>Dave Buff</h2>
	...
	<div class="container">
		<div class="row ftco-animate justify-content-center">
			<div class="col-md-6 col-lg-5 d-flex">
				<div class="testimony-img" style="background-image: url('{{asset('haircare/images/testimoni.jpg')}}');">
				</div>
			</div>
					...
					<div class="carousel-testimony owl-carousel ftco-animate">
						...
						<div class="item">
							<div class="testimony-wrap pb-4">
								...
								<div class="d-flex">
									<div class="user-img" style="background-image: url('{{asset('haircare/images/stylist-1.jpg')}}');">
									</div>
									<div class="pos ml-3">
