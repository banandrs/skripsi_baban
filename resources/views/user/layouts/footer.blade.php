      ...
      <div class="row mb-5">
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
            <h2 class="ftco-heading-2 logo">Sinemaku.</h2>
        ...
        <div class="ftco-footer-widget mb-4">
          ...
          <div class="block-23 mb-3">
            <ul>
              <li><a><span class="icon icon-map-marker"></span><span class="text">Jl. Profesor Dokter H. Hadari Kota Pontianak 78115</span></a></li>
              <li><a href="#"><span class="icon icon-phone"></span><span class="text">+62 857 5005 8435</span></a></li>
              <li><a href="#"><span class="icon icon-envelope"></span><span class="text">sinema@untan.ac.id</span></a></li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-md-12 text-center">
        ...
        <p>
          ...
          </script> All rights reserved </i> by <a href="https://colorlib.com" target="_blank">Andreas Nababan</a>
          <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
        </p>
      </div>
    </div>
